...
<body class="bg-gray-100">
    ...
    <div class="flex-1 p-6">
        <h2 class="text-2xl font-bold mb-6">Edit Tempat Taman</h2>
        ...
        <form id="editPlaceForm" action="<?= site_url('admin/updatePlace/' . $place['id']) ?>" method="post" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="link" id="link" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" value="<?= $place['link'] ?>">
            </div>
